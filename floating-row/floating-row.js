    ...
    return {
      ...
      link: function($scope, $element) {
        $document.bind('scroll', function() {
          ...
          if((elemBottom >= docViewTop) && (elemTop <= docViewBottom) && (elemBottom <= 
docViewBottom) &&  (elemTop >= docViewTop) ) {
            ...
            // $element.css("position", "absolute").css("width", $element.css("width") 
).css("top", $element.css("top") );
          } else {
            ...
            $element
              ...
              .css("top", "0px")
              .css("width", $element.parent().parent().css("width") );
            // $element.css("position", "fixed").css("top", "0px").css("width", 
$element.css("width") );
          }
        });
      }
